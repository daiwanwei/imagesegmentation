...
pretrained_url_50 = "https://github.com/fchollet/deep-learning-models/releases/download/v0.2/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5"
...
def get_resnet50_encoder(input_size,pretrained='imagenet', 
    ...
    #     weights_path = keras.utils.get_file( pretrained_url_50.split("/")[-1] , pretrained_url_50  )
    #     Model(  img_input , x  ).load_weights(weights_path)

    return img_input , [f1 , f2 , f3 , f4 , f5  ]


def get_resnet101_encoder(input_height=224 ,  input_width=224 , pretrained='imagenet' , 
